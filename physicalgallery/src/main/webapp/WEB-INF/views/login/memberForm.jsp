...
<form action="memberRegist.kd" method="post">
<table border="1">
		<tbody>
			<tr>
				<th>아이디</th>
			...
			<tr>
				<th>주소</th>
				<td><input type="text" name="memAdd1" placeholder="도로명 주소를 입력하세요">
			...
			<tr>
				<th>직업</th>
				<td>
					<input type="tel" name="memJob">			
				</td>
			</tr>
			<tr>
				<th>취미</th>
				<td>
					<input type="tel" name="memHobby">				
				</td>
			</tr>			
			<tr>
				<td>
